...
int main() {
	...
	// Load textures with utility function (See btm)
	unsigned int diffuseMap = loadTexture("assets/image/container2.png");
	unsigned int specularMap = loadTexture("assets/image/container2_specular.png");
