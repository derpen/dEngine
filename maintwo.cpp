...
int main() {
	...
	Shader cubeShader("shaders/lighting.vert", "shaders/lighting.frag");
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		glm::vec3 diffuseColor = lightColor		* glm::vec3(0.5f); // Decrease the influence (Whatever that means)
