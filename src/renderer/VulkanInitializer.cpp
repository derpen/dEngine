...
VkRenderingAttachmentInfo VulkanInit::depth_attachment_info(
...
VkPipelineShaderStageCreateInfo VulkanInit::pipeline_shader_stage_create_info(VkShaderStageFlagBits stage,
